...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Jan 2024 pada 03.06
...
(1, 'P001', 'DEWI', 'P', 'RPL', '093567214567', 'Jalan Gedongkuning'),
(2, 'P002', 'AMEL', 'P', 'RPL', '097456382134', 'Jalan Jambidan'),
(3, 'P003', 'KHAIL', 'L', 'RPL', '087564782345', 'Jalan Kenangan');
...
(1, 'A001', 'KANCIL', 'RAHMAT', 'PT.Gramedia', '2006', 50),
(2, 'A002', 'CINDERELLA', 'KARTIKA', 'PT.Gramedia', '2013', 23),
(3, 'A003', 'KATA', 'TSANA', 'Katadepan', '2018', 34);
...
(100, '2023-02-02', '2023-02-13', 1, 1, 23),
(110, '2023-03-10', '2023-03-20', 2, 2, 24),
(120, '2023-04-08', '2023-04-21', 3, 3, 25);
...
(105, '2023-02-13', 0, 1, 1, 23),
(109, '2023-03-20', 3000, 2, 2, 24),
(118, '2023-04-21', 0, 3, 3, 25);
...
(23, 'AHMAD', 'Penjaga perpustakaan', '085674344567', 'Bantul'),
(24, 'RATIH', 'Kepala perpustakaan', '084677638921', 'Sleman'),
(25, 'DANI', 'Petugas perpustakaan', '096778492313', 'Krapyak');
...
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `rak`
  MODIFY `id_rak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
